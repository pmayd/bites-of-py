...
def make_character_index(text=text, characters=CHARACTERS):
    ...
    for line_no, line in enumerate(text.splitlines()):
        for character in characters:
            ...
            if characters_in_line(character, line):
                index[character[0].lower()].append(line_no)

    return index        

def characters_in_line(characters, line):   
    return any(character.lower() in line.lower() for character in characters)
